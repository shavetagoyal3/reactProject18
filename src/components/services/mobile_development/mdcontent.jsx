      ...
      <section className="content">
        <section className="cemetery">
          <div className="container">
            <div className="cemetery__title mobile-development">
              <h2>Success stories</h2>
              <p>
                Fortune 500 companies and world-class brands trust our mobile
        ...
        <section className="service-why">
          ...
          <p className="service-why__description">
            Build a solid app faster with our mobile platform that has pre-made
            feature modules. Leverage our extensive expertise for an
            industry-specific solution, or an enterprise suite. More so, add
            technologies like Blockchain and Augmented Reality to elevate your
            business security, key operations, and employee productivity.
          </p>
          <section className="service-why__points">
            <div
              ...
              style={{
                backgroundImage:
                  `url(${require("../../../assets/5be2fa1f/img/services/mobile-development/enterpr_mini.jpg")})`
              }}
            >
              ...
              <div className="service-why__point-lead-content">
                <p className="service-why__point-lead">
                  Transfer your enterprise workflow to a mobile platform that
                  supports the devices you want to implement. An enterprise app
                  suite or a single application, your enterprise and employee
                  productivity will rise on all levels, allowing you to approach
                  key processes more efficiently, as well as cut costs.
                  Technologies like Augmented Reality and Artificial
                  Intelligence based solutions will facilitate the progress
                  further.
                </p>
              </div>
            </div>
            <div
              ...
              style={{
                backgroundImage:
                  `url(${require("../../../assets/5be2fa1f/img/services/mobile-development/mobile_pl_mini.jpg")})`
              }}
            >
              <div className="service-why__mask" />
              <h2 className="service-why__point-title">
              ...
              <div className="service-why__point-lead-content">
                <p className="service-why__point-lead">
                  Our mobile platform employs ready-made modules. Chatbots,
                  beacon based navigation, Augmented reality, data analytics,
                  and more — you choose what you need, we add touches to tailor
                  the features to your brand identity, and they become a part of
                  your app. As a result, your app is finished faster without
                  loss in quality. With our pre-made modules, you get everything
                  from custom mobile app development.
                </p>
              </div>
            </div>
            <div
              ...
              style={{
                backgroundImage:
                  `url(${require("../../../assets/5be2fa1f/img/services/mobile-development/indusrtry_mini.jpg")})`
              }}
            >
              <div className="service-why__mask" />
              <h2 className="service-why__point-title">
              ...
              <div className="service-why__point-lead-content">
                <p className="service-why__point-lead">
                  From Fintech and Construction to Retail and Sports,
                  Intellecsoft’s expertise covers the majority of industries. We
                  created an iPad app for Eurostar’s trains, a blockchain based
                  proximity payments platform, a marketing app for
                  Harley-Davidson, and more. You will get a spot-on mobile
                  solution that meets the demands of your customers.
                </p>
              </div>
            </div>
          </section>
        ...
        <section className="latest-teach">
          <div className="container">
            ...
            <p className="teach-description">
              Intellectsoft always keeps track of emerging technologies to
              deliver forward-thinking solutions. The latest tech give you many
              crucial benefits, from the highest level of security with
            ...
            <ul className="teach-items">
              <li className="teach-item active">
                ...
                <div className="more-info">
                  ...
                  <p className="item-description">
                    From private blockchains to cryptocurrency wallets to Smart
                    Contracts — use blockchain-based solutions for the highest
                    level of business security and automation.
                  </p>
                </div>
              </li>
              <li className="teach-item">
                ...
                <div className="more-info">
                  <h3 className="item-title">Augmented Reality</h3>
                  <p className="item-description">
                    From Construction to Retail to daily enterprise activities,
                    use the practical promise of AR to make your key operations
                    significantly more efficient and cut costs.
                  </p>
                </div>
              </li>
              <li className="teach-item">
                ...
                <div className="more-info">
                  <h3 className="item-title">Artificial Intelligence</h3>
                  <p className="item-description">
                    Employ machine and deep learning to analyse Big Data and
                    gain valuable insights. Build predictive models for
                    fail-safe decision making. Improve your customer experience,
                    as well as employee efficiency and enterprise security.
                  </p>
                </div>
              </li>
              <li className="teach-item">
                ...
                <div className="more-info">
                  ...
                  <p className="item-description">
                    ...
                    optimise them, and introduce pinpoint efficiency. Gain
                    crucial insights from the Big Data gathered by IoT devices
              ...
              <li className="teach-item">
                ...
                <div className="more-info">
                  <h3 className="item-title">FinTech</h3>
                  <p className="item-description">
                    Build a blockchain-based application to make your operations
                    and cross-border payments more secure. Create digital
                    wallets on a blockchain to let your users load and redeem
                    funds.
                  </p>
                </div>
              </li>
            ...
            <div className="capabilities-block">
              <div className="developers">
                ...
                <div className="dev-description">
                  ...
                  <p>
                    From API integration to ARKit solutions — our extensive
                    expertise in iOS mobile app development and Swift will help
                    you meet the high demands of Apple’s fans.
                  </p>
                </div>
                <div className="dev-description">
                  <div className="dev-title">
                  ...
                  <p>
                    Your app will consistently work across all devices and
                    leverage any Android tech available to date. Android mobile
                    app development has become one of our core strengths soon
                    after the platform was released in 2008.
                  </p>
                </div>
              </div>
              <div className="developers">
                ...
                <div className="dev-description">
                  ...
                  <p>
                    We can help you create cross-platform web-based apps,
                    establish real-time data sync with WebSockets, create a
                    Proof-of-Concept app, and more. We can build you a fast,
                    reliable backend, as well as create a secure IoT
                    infrastructure.
                  </p>
                </div>
                <div className="dev-description">
                  ...
                  <p>
                    Native apps with up to 50% code reuse, forms with up to 90%
                    shared code, complex client-server applications and data
                    visualisation via Syncfusion — these are the cornerstones of
                    our Xamarin mobile app development offering.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="service-dev-team">
          <div className="container">
            ...
            <p className="dev-team__description">
              Ten years in mobile app development have allowed us to craft a
              development process that ensures high productivity and efficiency.
              You will have the app you ordered us at initial stages, on time.
              We will also support it after the release to ensure its continuous
              operation.
            </p>
              ...
              <div className="clients__item clients__item--4">
                <div className="clients__content clients__content--block">
                  ...
                  <div className="clients__text clients__text--fluid">
                    <h3 className="clients__title clients__title--">Shell</h3>
                    <p className="clients__description clients__description--">
                      Shell’s Robert Training Center gets a custom mobile app
                      that helps its trainees, administrators, and visitors
                      navigate the 20-acre campus and communicate crucial
                      messages, making documentation digital and gathering it
                      one place.
                    </p>
                  </div>
                </div>
              ...
              <div className="clients__item clients__item--4">
                <div className="clients__content clients__content--block">
                  ...
                  <div className="clients__text clients__text--fluid">
                    ...
                    <p className="clients__description clients__description--">
                      Iconic motorcycle brand finds a fresh way to engage its
                      fans while on the road by creating a mobile app that
                      allows exhibition staff to sign prospective clients.
                    </p>
                  </div>
                </div>
              </div>
