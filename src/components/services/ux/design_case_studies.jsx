...
class DesignCaseStudies extends React.Component {
  render() {
    return (
        ...
        <div className="carousel">
          ...
          <div className="case-studies__item carousel-cell">
            <div
              ...
              style={{
                backgroundImage:
                  `url(${require("../../../upload/images/cases/ede9f1f9f16a705d791f6d12ea8bd5f834bbf9f8976bb188d49e52c193fadbf6.jpg")})`
              }}
            />
            <div className="case-studies__content">
              <h2 className="case-studies__heading">AlumTies</h2>
              <p className="case-studies__lead">
                A small start-up used Intellectsoft’s planning and development
                services to build an app for university alumni groups.
              </p>
              <a className="btn" href="../cases/alumties.html">
                Read the case study
              </a>{" "}
            </div>
          </div>
