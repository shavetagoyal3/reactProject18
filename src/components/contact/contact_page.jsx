            ...
            >
              <div className="form__box form__box--contact-page">
                ...
                <div className="form-group upload-wrapper js-emptyFiles">
                  ...
                  />
                  <label className="upload__label" htmlFor="attach">
                ...
                <div className="form__footer">
                  <div className="form-group no-validation-icon">
                    ...
                    />
                    <label
                      className="form__checkbox-label form__checkbox-label--black"
                      htmlFor="send_nda"
                    >
                      Send NDA{" "}
                    </label>
                  </div>
                  <p className="form__valid-fill form__valid-fill--black">
                    Please, fill all fields
                  </p>
                </div>
                <button className="form__submit form__submit--contact form__submit--contact-page">
                  Talk to our team{" "}
                </button>
